...
def getEasyListRules():
    """[Adblock Plus 1.1]
        ! Version: 202208161137
        ! Title: EasyPrivacy
        ! Last modified: 16 Aug 2022 11:37 UTC
    ...
    list=['&action=confection_send_data&',
'&action=js_stats&',
'&action=js_stats_',
'&callback=hitStats_',
'&event=view&',
...
'://ensighten.',
'://fathom.$domain=~fathom.info|~fathom.io|~fathom.video|~fathomdelivers.com|~fathomseo.com|~usesfathom.com',
'://geoip.*/country.json',
'://ivwextern.',
'://lightning.*/launch/',
...
'://tracking.*/event',
'://tracking.*/tr.js',
'://utm.$domain=~utm.akindi.com|~utm.arc.nasa.gov|~utm.edu|~utm.io|~utm.md|~utm.pansa.pl|~utm.pharos360.com|~utoronto.ca',
...
'||educationdynamics.com^$third-party',
...
'||3p-geo.yahoo.com^',
'||3p-udc.yahoo.com^',
'||4e4356b68404a5138d2d-33393516977f9ca8dc54af2141da2a28.ssl.cf1.rackcdn.com^',
...
'||api.blink.net/a/',
'||api.carrottrack.io^$third-party',
...
'||lycos.com/hb.js',
'||m.addthisedge.com^',
'||m.media-amazon.com/images/S/sash/PNsNtF7MLhjOEin.js$domain=imdb.com',
'||ma.logsss.com^',
...
'||survey.io/log?',
'||surveymonkey.com/collect/$third-party',
...
'||tag.rmp.rakuten.com^',
'||tag.search.sensefuel.live^$script,third-party',
'||tagcdn.com/pix/?',
'||tagger.opecloud.com^',
...
'||trustcommander.net/privacy/$third-party',
...
#'! Appcues',
'||fast.appcues.com^$script,third-party',
#'! taboola',
...
'||beam.giraffe360.com^',
'||bfp.capitalone.com^',
'||bhphotovideo.com/aperture/client/logs',
...
'||cnet.com/pageview_candidate.comscore.json',
'||cnt.hd21.com^',
'||cnt.iceporn.com^',
'||cnt.nuvid.com^',
'||cnt.viptube.com^',
...
'||flyasiana.com/ykjEIhcZLYg2zoOOoA/',
...
'||lastminute.com/service/track/',
'||lastminute.com^*/metrics',
...
'||messiah.id/api/event',
'||messiah.id/js/script.js',
...
'||momondo.com/s/vestigo/v1/measure',
'||mon.us.tiktokv.com^',
...
'||smallcapnetwork.com/zfbp/viewtracker/',
...
'||terabox.com/abdr?',
'||tgt.maep.ibm.com^',
'||thdstatic.com/data-collection/$domain=homedepot.com',
...
'||thetopfivevpn.com/tv5appf5cc137e72b40469905a.js',
'||thewindowsclub.com^*/skip-links.min.js',
...
'||ucoz.com/stat/',
'||ucweb.com/collect/',
'||udemy.com/api-2.0/visits/me/funnel-logs/',
'||uie.data.cbc.ca^',
...
'||wondershare.com/trk',
'||wscdn.com/analytics/',
'||wsj.com/asset/amt.js',
'||wstats.e-wok.tv^',
'||wtk.db.com^',
'||xfinity.com/event/',
'||xfinity.com/prod/event/',
'||xfinity.com/z8ufpC5q/',
'||xhcdn.com/js/track.',
'||xing.com/logjam/',
'||xstats.evoload.io^',
'||yahoo.com/beacon/',
...
'||ebaystatic.com/rs/v/enk4ekgiky2ufpj3l2fgfblxaqd.js',
...
'||foursquare.com/0UqK4c76/init.js',
...
'||lulus.com/px/client/main.min.js',
'||madlan.co.il/o4wPDYYd/init.js',
'||mouser.com/4UAZUiaI/init.js',
...
'||2qqfxz5kecr4.www.eldorado.gg^',
'||5p0utbv2mjq1.www.earthclassmail.com^',
'||634lj7p7g3lv.unstoppabledomains.com^',
'||8ehhtsv9bo7i.monkeylearn.com^',
'||8p0kiyq5mq1d.flex.team^',
'||av6fm8zw2cvz.furucombo.app^',
'||b20p6lt350nt.app.polymersearch.com^',
'||bygr2ri20e4y.li.finance^',
'||e5obq1v261.www.lurkit.com^',
'||fp84rw0jinz7.blanc.ru^',
'||gl5g98t0vfjb.panprices.com^',
'||gw5worvzkb4j.stoic.ai^',
'||hkhpnqciykaf.www.gamecamp.gg^',
'||jzbzvk10u32f.adria.gg^',
'||lh3pvljbkong.www.nookgaming.com^',
'||ouc82i67pytg.www.emanualonline.com^',
'||p9jhxqlkmn.miniso.com.gr^',
...
'||xo704w18yt75.filmustage.com^',
'||ydqv7yvf191i.www.logology.co^',
'||yhpknxzspo8a.kvest.ee^',
'||zkmhhr1fr79z.dictionary.basabali.org^',
#'! a8.net (https://github.com/AdguardTeam/cname-trackers/blob/master/trackers/a8_net.md)',
'||a8.01cloud.jp^',
'||a8.abemashopping.jp^',
'||a8.cyclemarket.jp^',
'||a8.denki-koji.work^',
...
'||a8cv.www.biyou-soushin.com^',
'||a8cv.www.biyou-wakiga.com^',
'||a8cv.ya-man.com^',
'||a8cv.yamato-gp.net^',
...
'||analytics.dogecoin.gg^',
'||analytics.explained-from-first-principles.com^',
'||analytics.fatalparadox.com^',
'||analytics.filiotech.com^',
'||analytics.forgetwp.com^',
'||analytics.gamedatacrunch.com^',
'||analytics.givealittle.co^',
'||analytics.hiome.com^',
'||analytics.itsnoahevans.co.uk^',
'||analytics.lunge.de^',
...
'||analytics.southjerseyquakers.org^',
'||analytics.ss88.us^',
'||analytics.sweep.net^',
...
'||analytics.wittypen.com^',
'||analytics.wpsermons.com^',
'||analytics.zingerwebdesign.com^',
...
'||pl.volunteeringauckland.org.nz^',
'||pl.volunteeringwaikato.org.nz^',
'||pl.volunteermarlborough.org.nz^',
'||pla.wigglepixel.nl^',
'||plas.imfeld.dev^',
'||plau.devitjobs.uk^',
'||plau.devitjobs.us^',
...
'||stat.tomdebruijn.com^',
'||statistics.csweapons.com^',
'||statistics.heatbeat.de^',
'||statistik.veronika-steiner.at^',
'||stats.123nz.nl^',
'||stats.45rpm.ch^',
'||stats.acadevor.com^',
'||stats.aixbrain.de^',
...
'||stats.amiibo.life^',
'||stats.arquido.com^',
'||stats.artefact.space^',
'||stats.audiorelay.net^',
'||stats.backprop.co^',
'||stats.baptistwomen.com^',
...
'||stats.lollipoptest.at^',
'||stats.lord.io^',
'||stats.ltdhunt.com^',
'||stats.ltodrivingschools.org^',
'||stats.lumen-app.com^',
...
'||stats.moderncoupmake.com^',
'||stats.motion-effect.com^',
'||stats.motornation.net^',
'||stats.mtsknn.fi^',
...
#'! ',
#'! at-o.net (https://github.com/AdguardTeam/cname-trackers/blob/master/trackers/at-internet-(formerly-xiti).md)',
...
'||metrics.extranet.sonyericsson.com^',
...
'||adbsmetrics.kia.com^',
'||adbsmetrics.kiavirtualexperience.com^',
...
'||sanalytics.cinemax.tv^',
'||sanalytics.express.de^',
'||sanalytics.hbobrasil.com^',
'||sanalytics.hbocaribbean.com^',
'||sanalytics.hbolatam.com^',
'||sanalytics.ksta.de^',
...
'||smetrics.audiserviceplans.ie^',
'||smetrics.autodesk.com.cn^',
...
'||y.ksl.com^',
#'! ',
#'! metrics.prd.base.be disguised trackers',
#'! ',
'||metrics.base.be^',
#'! ',
#'! unavailable.hearstnp.com disguised trackers',
#'! ',
'||metrics.chron.com^',
#'! ',
...
'||americantower.redit.com^',
'||bluemarblepayroll.actonservice.com^',
'||bold.windstreamwholesale.com^',
...
'||dfw.bakerbroto.emergeinteractive.com^',
'||digital.opsbase.com^',
...
'||info.dril-quip.com^',
'||info.drsearswellnessinstitute.org^',
'||info.e-tabs.com^',
'||info.eco.ca^',
'||info.edriving.com^',
'||info.em-ametek.com^',
...
'||marketing.theemeraldseattle.com^',
...
'||advisor.raa.com^',
'||advisorycloud-dev.actonservice.com^',
'||advocacy.ahip.org^',
...
'||info.clearfunction.com^',
'||info.compusource.com^',
'||info.cresinsueb.net.zooplus.fr^',
'||mpuq.net.zooplus.es^',
'||nautilus.net.zooplus.de^',
'||nbcxa65t002z.net.zooplus.fr^',
'||neso.r.niwepa.com^',
'||net.daraz.com.bd^',
'||net.daraz.com^',
'||net.daraz.pk^',
...
'||net.shop.com.mm^',
'||node.net.zooplus.nl^',
'||node.stg.mgmt.net.zooplus.de^',
'||nodeail.net.zooplus.it^',
'||northamerica.confluenceapi.net.zooplus.de^',
'||northamericamanagement.tpe.net.zooplus.de^',
'||ns.machinevision-getter.net.zooplus.it^',
'||ns.machinevision.webapp.net.zooplus.it^',
'||ns.v2.net.zooplus.it^',
...
'||oldapi.admins.net.zooplus.de^',
'||oldapi.login.net.zooplus.de^',
'||opel.net.zooplus.com^',
'||opslegacy.toolbar.net.zooplus.com^',
'||orava-prod.ext.net.zooplus.de^',
'||owa-tomcat.net.zooplus.de^',
'||owa-waf.net.zooplus.it^',
'||owa.apac.net.zooplus.it^',
'||owa.data.net.zooplus.fr^',
'||owa.frontpage.net.zooplus.nl^',
'||owa.jobs.net.zooplus.it^',
'||owa.net.zooplus.de^',
'||owa.ns.machinevision.net.zooplus.it^',
'||owa.release.net.zooplus.nl^',
'||owa.s3.net.zooplus.fr^',
'||owa.wwww.net.zooplus.it^',
'||owaapiserver.net.zooplus.it^',
'||owachd.net.zooplus.fr^',
'||owadata.net.zooplus.fr^',
'||owalogin-waf.net.zooplus.it^',
'||owanorthamerica.net.zooplus.it^',
'||owastage.net.zooplus.de^',
'||payangopn.ingenioustech.biz^',
'||perf.af.eficads.com^',
'||perf.af.funneldrivers.com^',
'||phpmyadmin.devm.net.zooplus.fr^',
'||pluto.r.powuta.com^',
'||pny.net.penny.de^',
'||portal-gw.net.zooplus.it^',
'||portal.gitmanagement.net.zooplus.de^',
'||portal.t.net.zooplus.it^',
'||portaling.net.zooplus.fr^',
'||prd-portal.net.zooplus.it^',
'||prd-ssl.net.zooplus.es^',
'||prd-ssl.net.zooplus.it^',
'||prd.net.zooplus.it^',
'||prding.net.zooplus.it^',
'||preview-tail.net.zooplus.it^',
'||preview.owa.net.zooplus.nl^',
'||projects.net.zooplus.com^',
'||promo.old.legacy.tester.net.zooplus.com^',
'||promocsr41.net.zooplus.de^',
'||promoowa.net.zooplus.fr^',
'||qa1.dr.goldenserviceawards.net.zooplus.fr^',
'||r.jakuli.com^',
'||rawmail.net.zooplus.nl^',
'||rawowa.net.zooplus.it^',
'||redir.mgmt.net.zooplus.de^',
'||redir.net.zooplus.de^',
'||redirect-authentication.net.zooplus.it^',
'||redirect-ssl-administrator.net.zooplus.it^',
'||redirect-sslmachinevision.net.zooplus.it^',
'||redirect.net.zooplus.de^',
'||redirector.webstats.net.zooplus.com^',
'||renaultbankdirekt.efscle.com^',
'||repo-ssl-global.net.zooplus.es^',
'||residenz.net.zooplus.de^',
'||rw.net.rewe.de^',
'||schwaebischhall.efscle.com^',
'||search.repository-legacy.net.zooplus.com^',
'||searchmarketing.net.zooplus.nl^',
'||searchssl.net.zooplus.es^',
'||secapi.net.zooplus.de^',
'||server-gw.net.zooplus.de^',
'||server3.dev1.na.sandbox.gwsweb.net.zooplus.de^',
'||smartbroker.efscle.com^',
'||sonar6.xy.fbcdn.net.iberostar.com^',
'||srd3-ord.net.zooplus.fr^',
'||ssl-k8s.net.zooplus.es^',
'||star.net.zooplus.de^',
'||stg.profile.net.zooplus.de^',
'||stg.v2.net.zooplus.de^',
'||stgx.net.zooplus.de^',
'||storm.net.zooplus.com^',
'||sts.ssl.net.zooplus.es^',
'||support.api.prod.net.zooplus.de^',
'||support.data-api.net.zooplus.de^',
'||support.labapi.net.zooplus.de^',
'||support.nginxapi.net.zooplus.de^',
'||sync.hausgebrauch.net.zooplus.de^',
'||team.net.zooplus.de^',
'||team.old.legacy.tester.net.zooplus.com^',
'||techssl.net.zooplus.de^',
'||test-marketing.net.zooplus.it^',
'||testbed.net.zooplus.de^',
'||tester-mail.net.zooplus.it^',
'||testercsr41.net.zooplus.de^',
'||testerlax-mgmt.net.zooplus.de^',
'||testing.net.zooplus.com^',
'||testing.net.zooplus.es^',
'||testing.stg.hwcdn.net.zooplus.de^',
'||testingmgmt.control.docker.net.zooplus.de^',
'||um2ext.sip.net.zooplus.de^',
'||video.fpbc1-1.fna.fbcdn.net.iberostar.com^',
'||video.fpbc1-2.fna.fbcdn.net.iberostar.com^',
'||vpn4-238.net.zooplus.fr^',
'||wpthemes.yusop.net.zooplus.de^',
'||www.arturoaraujob.net.zooplus.fr^',
'||www.freeoh.net.zooplus.fr^',
'||www.kaanapalioceanadventures.com.websitedesignroom.net.zooplus.fr^',
'||www.marketing-investors-preview.net.zooplus.es^',
'||www.onlineattorney.net.zooplus.fr^',
'||www.plantationshuttersmelbourne.com.au.websitedesignroom.net.zooplus.fr^',
'||xe-2-1-3--bbr2-dfw.net.zooplus.de^',
#'! ',
...
'||lrtjvd.wordans.com^',
'||lrupwq.freedomdebtrelief.com^',
'||lsbeim.mediamart.vn^',
'||lsoiat.svetodom.ru^',
'||lspfuw.siwonschool.com^',
'||lsqswk.supersonicgolf.com^',
'||lsxxxr.lecreuset.co.jp^',
'||ltaoei.rendez-vous.ru^',
...
'||nsikar.ackermann.ch^',
'||nstclj.rubylane.com^',
'||ntnnpj.cacharel.com.tr^',
'||ntopcd.underarmour.nl^',
'||ntpnmx.zlato.ua^',
'||nturnm.unisport.dk^',
'||nuvdii.nouw.com^',
'||nvcqii.multivarka.pro^',
'||nvpdaa.brightcellars.com^',
'||nwbpsg.amso.pl^',
'||nwyhtl.hollyhood.com.tr^',
'||nxnszu.ettoday.net^',
'||nyceov.life.ru^',
...
'||trkpzz.dcinside.com^',
'||trkpzz.manpeace.org^',
'||tscrje.designonline24.nl^',
'||tshuxi.bbqguys.com^',
'||txpbnm.sevellia.com^',
'||txyqik.jjshouse.fr^',
'||tybfxw.puma.com^',
'||uansiq.clip.mx^',
'||uavwjp.millers.com.au^',
'||uazmti.a101.com.tr^',
'||ubdjfy.maje.com^',
'||ubdsej.notino.pl^',
'||ubmitt.heine.ch^',
...
'||vzlmcd.spellbinderspaperarts.com^',
...
'||yftkzg.footballleagueworld.co.uk^',
...
'||zdowtv.internet-outdoorshop.com^',
...
'||rdtcnt.laredoute.fr^',
'||rdtdlv.laredoute.fr^',
'||sr-dynamic-content.ext.api.leclerc^',
#'! ',
...
#'! ',
#'! hs.eloqua.com disguised trackers',
#'! ',
...
'||choose.nu.edu^',
'||clicks.tableau.com^',
'||clinical.questdiagnostics.com^',
'||clogindustresmails.carte-gr.total.fr^',
'||cloud.aspiresys.com^',
...
'||cockpitexchanges.carte-gr.total.fr^',
'||cockpitproximity.carte-gr.total.fr^',
'||cockpitwaykonectoryz.carte-gr.total.fr^',
'||comm.toro.com^',
...
'||cookie.solutions.desertfinancial.com^',
'||cookiejar.atea.no^',
'||cookies.ec4u.com^',
...
'||easymonitoringnm.carte-gr.total.fr^',
'||eb.endeavorb2b.com^',
'||eb.informabi.com^',
'||ebusinesssr.carte-gr.total.fr^',
'||ec.infosys.com^',
...
'||ehtel.endress.com^',
'||election-sandwich-en-stationi.carte-gr.total.fr^',
'||eloq.fiducial.fr^',
...
'||emeaevents.americanexpress.com^',
'||empresa.ricoh.es^',
...
'||events.mywd.com^',
'||events.newyorklifeinvestments.com^',
'||events.regis.edu^',
'||events.splunk.com^',
...
'||experience.techmahindra.com^',
'||experienceal.carte-gr.total.fr^',
...
'||fan.volleyball.world^',
'||febusiness.carte-gr.total.fr^',
'||fedcbaii.carte-gr.total.fr^',
'||feedback.vegasgoldenknights.com^',
'||fhages.carte-gr.total.fr^',
'||food.informaengage.com^',
'||forms.bmc.com^',
'||forms.bumrungrad.online^',
...
'||info.onemedical.com^',
'||info.onetrust.com^',
'||info.onetrustgrc.com^',
'||info.perkinelmer.com^',
'||info.regis.edu^',
'||info.response.sagaftra.org^',
'||info.reutersagency.com^',
'||info.scorecardrewards.com^',
'||info.shavve.co.il^',
'||info.spurs.com^',
'||info.unis.edu.gt^',
'||info.wolterskluwer.it^',
...
'||lantern.kronos.in^',
'||lantern.kronos.mx^',
'||lantern.kronosglobal.de^',
'||lantern.kronosglobal.fr^',
...
'||m.custom.info.shutterstock.com^',
'||m.premier.info.shutterstock.com^',
'||m.smb.info.shutterstock.com^',
'||ma.hmhco.com^',
...
'||srqpoim.carte-gr.total.fr^',
'||srqponmd.carte-gr.total.fr^',
'||ssitern-rcm.carte-gr.total.fr^',
'||st.azcardinals.com^',
'||stagezomation.carte-gr.total.fr^',
'||stat.altalex.com^',
'||stat.bdc.ca^',
'||stat.ciss.es^',
'||stat.dbschenker.com^',
...
'||subscribe.dnv.com^',
'||subscribe.dnvgl.com^',
'||successtorynm.carte-gr.total.fr^',
...
'||tracking.janssenmedicalcloud.ru^',
...
'||tracking.pgi.com^',
'||tracking.pharmanewsintel.com^',
'||tracking.pirelli.com^',
'||tracking.precisely.com^',
'||tracking.privatleasing.dk^',
...
'||trk.evtechexpo.com^',
'||trk.findmanufacturingbuyers.com^',
...
'||jj85xnjq.ybqwah.ntt.com^',
'||maz.zba.jp^',
'||mcad.mods-clinic.com^',
'||mgn.ebis.andbe-official.com^',
'||msr.p-antiaging.com^',
...
'||cpgo.avatacar.com^',
'||cpk.princessetamtam.com^',
'||cpr.comptoirdescotonniers.com^',
'||cse3.chausport.com^',
'||csv4.ebs-paris.fr^',
'||ct5m.citadium.com^',
'||ctp1.bforbank.com^',
...
'||gfn1.ugap.fr^',
'||gfv4.destinia.co.za^',
'||gti3.culture.leclerc^',
'||gti3.hightech.leclerc^',
...
'||ablinks.picsart.com.cdn.cloudflare.net^',
'||ablinks.picsart.com^',
...
'||link.email.atumanera.burgerking.com.mx^',
'||link.email.bnext.es^',
...
'||url7424.email.readytotravel.com^',
'||url7542.fluz.app^',
'||url7962.careerkarma.io^',
...
'||neko-san.fr/stats',
'||ouedkniss.com/spf/page-view',
'||ouedkniss.com/static/alexa.js',
'||ouedkniss.com/static/pixel.js',
'||p.kolplay.com^',
'||p.pagesjaunes.fr^',
'||pixel.dugwood.com^',
'||pixel.ionos.fr^',
...
'@@||adobedtm.com/*-libraryCode_source.min.js$script,domain=ally.com|americanexpress.com|crave.ca|nbarizona.com',
'@@||adobedtm.com/*-source.min.js$script,domain=53.com|aarp.org|ally.com|americanexpress.com|atresplayer.com|backcountry.com|bose.com|bt.com|cadenaser.com|churchofjesuschrist.org|cibc.com|crave.ca|currys.co.uk|dollargeneral.com|etihad.com|healthsafe-id.com|hilton.com|ing.com.au|ingrammicro.com|kroger.com|natwest.com|nbarizona.com|news.sky.com|personal.natwest.com|ssrn.com|telus.com|verizon.com|virginplus.ca|walgreens.com',
'@@||adobedtm.com/*_source.min.js$script,domain=backcountry.com|hl.co.uk|kroger.com|telus.com',
'@@||adobedtm.com/extensions/$script,domain=apple.com|bravotv.com|cadenaser.com|crave.ca|foodnetwork.com|telus.com|verizon.com',
...
'@@||browser.sentry-cdn.com^$domain=dic.pixiv.net|doconcall.com.my|eco-clobber.co.uk|menshealth.com|timesprime.com|womenshealthmag.com',
...
'@@||cdn.segment.com/analytics.js/$script,domain=app.cryptotrader.tax|fender.com|finerdesk.com|givingassistant.org|inxeption.io|my.foxnews.com',
...
'@@||cms.gentwo.com/pulses/$~third-party,xmlhttprequest',
...
'@@||console.otc.t-systems.com/mrs/rest/api/v1/log?type=$~third-party,xmlhttprequest',
...
'@@||cpt-static.gannettdigital.com/universal-web-client/master/latest/elements/vendor/adobe/',
...
'@@||dynamicyield.com/st?$script,domain=computeruniverse.net|croma.com|fendi.com|harborfreight.com|thewarehouse.co.nz|zalora.com.my|zalora.com.ph|zalora.sg',
...
'@@||enchambered.com^*/googleanalytics_2.js?',
...
'@@||fast.fonts.net/jsapi/core/mt.js$script,domain=gables.com|itsolutions-inc.com',
...
'@@||google-analytics.com/analytics.js$domain=beinsports.com|brooklinen.com|healthrangerstore.com|jackbox.tv|k2radio.com|koel.com|kowb1290.com|stressless.com|tracking.narvar.com|westernunion.com',
'@@||google-analytics.com/plugins/ga/inpage_linkid.js$domain=westernunion.com',
'@@||googleoptimize.com/optimize.js$script,domain=inquirer.com|lodgecastiron.com|tentree.ca',
'@@||googletagmanager.com/gtag/js$script,domain=carhartt-wip.com|cbslocal.com|honeystinger.com|kawasaki.com|livongo.com|m.putlocker.how|mediaite.com|schwab.com|toptal.com|virginplus.ca',
'@@||googletagmanager.com/gtm.js$domain=acehardware.com|ads.spotify.com|aeromexico.com|atptour.com|backcountry.com|bsa-whitelabel.com|carhartt-wip.com|ccleaner.com|chipotle.com|complex.com|crello.com|cyclingnews.com|cypress.io|doodle.com|easternbank.com|flytap.com|formula1.com|fortune.com|gorillamind.com|gumtree.com|harveynorman.co.nz|harveynorman.com.au|independent.co.uk|jn.pt|kedronparkhotel.com.au|level.travel|mcgeeandco.com|nflgamepass.com|nordvpn.com|nourison.com|oakandfort.com|petsathome.com|pioneer.eu|primeoak.co.uk|qrcode-monkey.com|royalbank.com|scotsman.com|soundguys.com|stressless.com|support.creative.com|trademe.co.nz|tumi.com|uniqlo.com|uqr.to',
...
'@@||js.monitor.azure.com/scripts/$script,domain=microsoft.com',
'@@||js.sentry-cdn.com^$script,domain=book.dmm.com|interacty.me|jobs.ch|pizzahut.com.au',
'@@||js.taplytics.com/jssdk/$domain=foxnews.com',
...
'@@||kaptcha.com/collect/sdk?$domain=wyze.com',
...
'@@||maxmind.com^*/geoip.js$domain=aljazeera.com|ballerstatus.com|bikemap.net|carltonjordan.com|cashu.com|coolsport.tv|dereon.com|dr.dk|driftinnovation.com|everydaysource.com|fab.com|girlgames4u.com|incgamers.com|ip-address.cc|maaduu.com|qatarairways.com|sat-direction.com|sotctours.com|stoli.com|vibe.com',
'@@||maxmind.com^*/geoip2.js$domain=boostedboards.com|donorschoose.org|elgato.com|fallout4.com|filld.com|ibanez.com|instamed.com|metronews.ca|mtv.com.lb|runningheroes.com|teslamotors.com',
...
'@@||mpsnare.iesnare.com^$script,domain=citi.com|citibank.com|enmasse.com|equifax.ca|jbhifi.com.au|login.skype.com|usbank.com|vitacost.com|westernunion.com',
...
'@@||optimizely.com/datafiles/$domain=nike.com|talktalk.co.uk|tommy.com|wallapop.com',
...
'@@||parsely.com/keys/wrif.com/p.js$script,domain=wrif.com',
...
'@@||songstats.com/api/v1/analytics/track_data$~third-party,xmlhttprequest',
...
'@@||survey.userneeds.com^$subdocument,domain=foreca.com|forecaweather.com',
'@@||switchfly.com/static/108f088/resources/shopping/.build/scripts/analytics-$script,domain=reise-services.americanexpress.de|travel.americanexpress.co.uk|viaggi.americanexpress.it',
...
'@@||tags.tiqcdn.com/utag/*/utag.sync.js$script,domain=vmware.com',
...
'@@||xumo.com/xumocdn/*/beacon?$domain=roku.com',
...
'@@||youbora.com/*/js/adapters/theoplayer$script',
...
'@@||api.cxense.com/public/widget/data?$script,domain=handelsblatt.com',
...
'@@||derwesten.de/resources/*/img/transparent_pixel.png$image,~third-party',
...
'@@||googletagmanager.com/gtm.js$domain=betten.de|bunte.de|computerbild.de|finanzen.at|finanzen.net|freenet-funk.de|idealo.at|idealo.de|radiorur.de|saturn.at|sport1.de|vox.de',
...
'@@||online.mps-gba.de/praeludium/caravAFW.js?$domain=caravaning.de',
...
'@@||scdn.cxense.com/cx.cce.js$script,domain=handelsblatt.com',
...
'@@||tra.scds.pmdstatic.net/sourcepoint/$domain=businessinsider.fr|voici.fr',
...
#'! ---------- Dutch ----------',
#'! ',
'@@||2doc.nl^*/vpro-analytics/Analytics.js$xmlhttprequest',
...
'@@||vpro.nl^*/vpro-analytics/Analytics.js$xmlhttprequest',
#'! ',
#'! ---------- Finnish ----------',
#'! ',
...
'@@||cdn.trustcommander.net/privacy$script,domain=enigaseluce.com',
...
'@@||service.maxymiser.net^$script,domain=enigaseluce.com',
...
'@@||api.cxense.com/document/search?$script,domain=tv-tokyo.co.jp',
'@@||api.cxense.com/document/search?$xmlhttprequest,domain=friday.kodansha.co.jp',
'@@||api.cxense.com/public/widget/data?$script,domain=mainichi.jp|wpb.shueisha.co.jp',
'@@||api.cxense.com/public/widget/data?$xmlhttprequest,domain=cyclestyle.net',
'@@||api.cxense.com/public/widget/data|$xmlhttprequest,domain=friday.gold|friday.kodansha.co.jp',
...
'@@||cdn.cxense.com/cx.js$domain=tarzanweb.jp|tv-tokyo.co.jp|wpb.shueisha.co.jp',
...
'@@||d-card.jp/st/common/js/googleTagManager.js',
...
'@@||muumuu-domain.com/common/js/ga_social_tracking.js',
...
'@@||rtoaster.jp/Rtoaster.js$domain=satofull.jp',
...
'@@||scdn.cxense.com/cx.cce.js$domain=mainichi.jp|wpb.shueisha.co.jp',
'@@||scdn.cxense.com/cx.js$script,domain=cyclestyle.net|mainichi.jp',
...
'@@||googletagmanager.com/gtm.js?id=$script,domain=komputronik.pl',
...
'@@||googletagmanager.com/gtm.js$domain=insiderstore.com.br|netcombo.com.br|saraiva.com.br|superesportes.com.br|topper.com.br|tugatech.com.pt',
...
'@@||doctorzerenia.com/home/bower_components/angulartics-google-analytics/dist/angulartics-ga.min.js',
...
def startWithBQ():
    ...
    query="select distinct(url) from cookies.requests where url NOT IN(  SELECT     url   FROM     cookies.tmp_requests_tracker_processed) limit 10000000"
...
def doAnalyse(rows):
    ...
    for item in rows:
        r = {}
        r['url'] = item[0]
        r['is_tracker'] = int(rules.should_block(item[0]))

        reqList.append(r)

        if len(reqList) > chunk_size:
            pushRows('cookies.tmp_requests_tracker_processed', reqList)
            reqList = []
